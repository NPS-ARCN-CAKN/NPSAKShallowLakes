...
#' @param ZoomLevel Initial zoom level for the lake map. Around 12-15 is usually appropriate. The user may change the zoom level when after the map is generated.
#' @return A Leaflet map for Lake.
#' @examples
#' # Get a Leaflet map showing Lake YUCH-004 at zoom level 13
#' GetLakeMap('YUCH-004',13)
#' @export
GetLakeMap = function(Lake,ZoomLevel){
